 ...
 */
export default function MonperMark({ className = '' }: { className?: string }): JSX.Element {
  return (
    <span
      aria-hidden
      className={`monper-mark inline-block shrink-0 bg-current ${className}`}
      style={{
        maskImage: `url(${logo})`,
