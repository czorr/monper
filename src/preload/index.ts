...
const api: TitanioApi = {
  ...
  newBookmarkFolder: (title: string) => ipcRenderer.invoke('bookmarks:newFolder', title),
  renameBookmark: (id: string, title: string) => ipcRenderer.send('bookmarks:rename', id, title),
  moveBookmark: (id: string, parentId: string | null) => ipcRenderer.send('bookmarks:move', id, parentId),
  collapseBookmarkFolder: (id: string, collapsed: boolean) => ipcRenderer.send('bookmarks:collapse', id, collapsed),
